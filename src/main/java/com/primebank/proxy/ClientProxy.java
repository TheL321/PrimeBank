...
public class ClientProxy extends CommonProxy {
    ...
    public void registerClientPackets() {
        // English: Register real S2C packet handlers on the client side.
        // Español: Registrar handlers reales de paquetes S2C en el lado del cliente.
        Net.registerClientS2CHandlers();
    }
}
